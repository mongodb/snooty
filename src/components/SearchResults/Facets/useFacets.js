...
// Temporary mapping of facets. Remove in favor of API request
const sampleJson = {
  data: [
    {
      type: 'facet-option',
          ...
          facets: [
            {
              type: 'facet-option',
              id: 'sub_product',
              key: 'target_product>atlas>sub_product',
              name: 'Sub Product',
              options: [
                {
                  type: 'facet-value',
                  id: 'atlas-app-services',
                  key: 'target_product>atlas>sub_product',
                  name: 'App Services',
                  facets: [],
                },
          ...
          facets: [
            {
              type: 'facet-option',
              id: 'sub_product',
              key: 'target_product>realm>sub_product',
              name: 'Sub Product',
              options: [
                {
                  type: 'facet-value',
...
const useFacets = () => {
  ...
  useEffect(() => {
    const fetchFacets = async () => {
      // const res = await fetch(assertTrailingSlash(MARIAN_URL) + 'v2/status');
      // const jsonResult = await res.json();
      // setFacets(jsonResult);
      setFacets(sampleJson.data);
    };
    fetchFacets();
  }, []);
