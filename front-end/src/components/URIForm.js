      ...
      <form className="uriwriter__form" id="uriwriter" autoComplete="off">
        ...
        >
          ...
          <ul className="guide__pills">
            <li className="uriwriter__toggle guide__pill guide__pill--active">
              local MongoDB
            </li>
            <li className="uriwriter__toggle guide__pill">
              local MongoDB with replica set
            </li>
          </ul>
        </div>
        <label
          className="mongodb-form__prompt uriwriter__atlascontrols"
          style={{ display: "none" }}
        >
          ...
          <div>
            <textarea
              ...
              id="uriwriter_atlaspaste"
              spellCheck="false"
              rows="3"
              cols="50"
              placeholder='mongo "mongodb+srv://clustername.mongodb.net/test" --username user'
            />
            <div className="atlascontrols__status mongodb-form__status" />
          </div>
        </label>
        <div id="userinfo_form">
          ...
          <div className="mongodb-form__prompt" data-server-configuration="">
            ...
            <div id="hostlist">
              ...
              />
              <div className="mongodb-form__status" />
            </div>
          </div>
        </div>
      </form>
