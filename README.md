...
Once Rust is installed, you'll need to build the plugin. Change directory to `component-factory-transformer`, run `cargo build` if you haven't, and then run `npm run prepublishOnly`.
