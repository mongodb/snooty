  ...
  const toc: TocItem[] = [
    {
      ...
      url: '/quick-start',
      glyph: 'Bulb',
      prefix: '/{version}/csharp/bianca.laube/DOP-5372',
      items: [
        {
        ...
        },
        {
          ...
          group: true,
          prefix: '/master/cloud-docs/bianca.laube/DOP-5372',
          items: [
            {
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Docs Compass',
          prefix: '/master/compass/bianca.laube/DOP-5372',
          group: true,
          items: [
            {
              label: 'Overview',
    ...
    },
    {
      ...
      url: '/builders',
      prefix: '/master/java/bianca.laube/DOP-5372',
      items: [
        {
            label: 'Overview',
            url: '/builders'
        },
        {
          ...
          items: [
            ...
            },
            {
              label: 'C driver',
              showSubNav: true,
              prefix: '/master/c/bianca.laube/DOP-5372',
              url: '/async-c-driver',
              items: [
                {
                  label: 'C Driver',
