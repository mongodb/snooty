...
//const data= require('/Users/anabella.buckvar/snooty/snooty/src/components/OpenAPIChangelog/components/data.js');
...
const fetchChangelogData = async (runId, versions, s3Prefix) => {
  try {
    ...
    const hideChanges = (changelog) => {
      ...
      //return updatedChangelog= changelog.map(dateUpdate);
